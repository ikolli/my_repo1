...
CREATE OR REPLACE USER ikolli_practice -- adjust user name
PASSWORD = 'TestSample123' -- add a secure password
LOGIN_NAME = 'ikolli_practice' -- add a login name
FIRST_NAME = 'Indrani' -- add user's first name
LAST_NAME = 'Kolli' -- add user's last name
EMAIL = 'ikolli@aep.com' -- add user's email
...
GRANT ROLE SYSADMIN TO USER ikolli_practice;
